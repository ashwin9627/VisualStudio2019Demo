...
namespace ProductivityFeatures
{
    class Update160
    {
        ...
        private const string V = @"<([A-Z][A-Z0-9]*)\b[^>]*>(.*?)</1>";
        ...
        public void RegexParsingSupport()
        {
            ...
            var match = new Regex(@"(A|[B]|C)Test\1").Match("ATestC");
    ...
    //    public class ExtractInterfaceToSameFile : IExtractInterfaceToSameFile1
    //    {
    //        public bool A() => false;
